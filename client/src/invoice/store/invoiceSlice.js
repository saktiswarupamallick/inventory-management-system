...
export const invoiceSlice = createSlice({
  ...
  reducers: {
    ...
    setNewInvoices: (state, action) => {
      ...
      localforage.setItem(ORDERS_KEY, updateState);

      const newDetailList = [...state.detailList, { ...payload, id }];
      state.detailList = newDetailList;
      localforage.setItem(ORDER_DETAILS, newDetailList);
    },
    ...
    onConfirmDeletedInvoice: (state, action) => {
      ...
      localforage.setItem(ORDERS_KEY, newDatas);
      localforage.setItem(ORDER_DETAILS, newDetails);
    },
    ...
    onConfirmEditInvoice: (state, action) => {
      ...
      localforage.setItem(ORDERS_KEY, [...state.data]);
    },
    ...
    updateNewInvoiceForm: (state, action) => {
      ...
      localforage.setItem( ORDER_FORM_KEY, { ...state.newForm });
    },
    ...
    updateExisitingInvoiceForm: (state, action) => {
      ...
      localforage.setItem(ORDERS_KEY, [...state.data]);
      localforage.setItem(ORDER_DETAILS, [...state.detailList]);
    },
