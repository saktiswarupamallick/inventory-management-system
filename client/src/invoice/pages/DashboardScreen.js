  ...
  return (
    <div className="">
      ...
      <div className="flex flex-wrap">
        <div className="w-full font-Poppins lg:w-4/6 pl-4 pr-4 sm:pl-4 sm:pr-0 mb-4 sm:mb-1">
          <DashboardWidgets />
          <div className="mt-1">
            <InvoiceTable />
          </div>
        ...
        <div className="w-full lg:w-2/6 pl-4 pr-4 sm:pl-4 sm:pr-2">
          <div>
            <Button style={{border:"3px solid black" ,borderRadius:"10px",backgroundColor:"#d19fe8"}} onClick={goToNewInvoice} block={1}>
              <InvoiceIcon />
