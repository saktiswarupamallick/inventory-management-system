    ...
    <>
      {showAdvanceSearch === true && (
        <div className="bg-white rounded-xl px-3 py-3 mb-3">
          <div style={{color:"black"}} className="font-title mb-2">Advanced Search</div>
          <div className="flex w-full flex-col sm:flex-row">
            <div className="mb-2 sm:mb-0 sm:text-left text-default-color flex flex-row font-title flex-1 px-2">
              <div style={{border:"3px solid black",backgroundColor:"yellow"}} className="h-12 w-12 rounded-2xl bg-yellow mr-2 flex justify-center items-center">
                <InvoiceIcon className="h-6 w-6 text-black  color-green" />
              </div>
      ...
      <div className="sm:bg-white rounded-xl sm:px-3 sm:py-3">
        <div className="hidden sm:flex invisible sm:visible w-full mb-6 flex-col sm:flex-row">
          <div style={{color:"black"}} className="sm:text-left font-bold text-black font-title flex-1">
            Invoice Name
          </div>
          <div style={{color:"black"}} className="sm:text-left font-bold text-black font-title flex-1">
            Client Name
          ...
          <div style={{color:"black"}} className="sm:text-left font-bold text-default-color font-title sm:w-11">
            Action
          </div>
        </div>
        ...
        <div>
          {currentItems &&
            currentItems.map((invoice) => (
              <div style={{border:"3px solid black" , padding:"7px"}} className={defaultTdWrapperStyle} key={invoice.id}>
                ...
                <div className={defaultTdStyle}>
                  ...
                  <div className={defaultTdContent}>
                    <span className="whitespace-nowrap text-ellipsis overflow-hidden" style={{color:"black"}}>
                      {invoice.clientName}
                    </span>
                  </div>
                </div>
