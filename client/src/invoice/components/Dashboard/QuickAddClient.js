  ...
  return (
    <div className="bg-white rounded-xl p-4">
      ...
      <div className="flex mt-2">
        {isInitLoading ? (
          <Skeleton className="skeleton-input-radius skeleton-image border-dashed border-3" />
        ) : (
          <ImageUpload
        ...
        <div className="flex-1 pl-3" >
          {isInitLoading ? (
            ...
            <div>
              <input style={{border:"3px solid black" , color:"black"}}
                autoComplete="nope"
      ...
      <div className="mt-3">
        <Button style={{border:"3px solid black"}} onClick={submitHandler} block={1}>
          <span className="inline-block ml-2 text-black"> Submit </span>
        </Button>
      </div>
    </div>
  );
