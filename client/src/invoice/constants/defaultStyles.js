...
export const defaultInputStyle = defaultStyle + "border-black h-12 flex-1";
...
export const defaultInputLargeStyle = defaultStyle + "border-black h-14";
...
export const defaultInputSmStyle =
  defaultStyle + "border-black h-8 text-sm flex-1";
export const defaultInputSmInvalidStyle =
  defaultStyle + "border-red-400 h-8 text-sm flex-1";

// Default Table Styles
export const defaultTdStyle =
  "text-sm sm:text-left text-black font-title flex flex-wrap flex-row flex-1 whitespace-nowrap text-ellipsis overflow-hidden mb-1";
export const defaultTdActionStyle =
  "text-sm sm:text-left text-black font-title flex flex-row sm:w-11";
