    ...
    <>
      {showAdvanceSearch === true && (
        <div className="bg-white rounded-xl px-3 py-3 mb-3">
          ...
          <div className="flex w-3/5 flex-col sm:flex-row">
            <div className="mb-2 m-2 sm:mb-0 sm:text-left text-default-color flex flex-row font-title flex-1 px-2">
              <div style={{ border: "3px solid black", borderRadius: "10px",backgroundColor:"#d19fe8" }} className="h-12 w-12 rounded-2xl bg-gray-100 mr-2 flex justify-center items-center">
              <SearchIcon  style={{color:"black"}}/>
                
              </div>
              <input style={{ border: "3px solid black", borderRadius: "10px" }}
                autoComplete="nope"
      ...
      <div className="sm:bg-white rounded-xl sm:px-3 sm:py-3">
        <div className="hidden sm:flex mb-6 invisible sm:visible w-full flex-col sm:flex-row">
          <div className="sm:text-left text-black font-title flex-1">
            Name
          </div>
          <div className="sm:text-left text-black font-title flex-1">
            Mobile
          ...
          <div className="sm:text-left text-black font-title sm:w-11">
            Action
          </div>
        </div>
        ...
        <div>
          {currentItems &&
            currentItems.map((client) => (
              <div style={{ border: "3px solid black", padding: "5px" }} className={defaultTdWrapperStyle} key={client.id}>
                  ...
                  <div className={defaultTdContent}>
                    {client.image ? (
                      <img
                        ...
                        className="object-cover h-12 w-12 rounded-2xl"
                        src={client.image}
                        alt={client.name}
                      />
                    ) : (
