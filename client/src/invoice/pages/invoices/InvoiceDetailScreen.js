        ...
        >
          ...
          >
            <div className="flex-1">
              <div className="flex flex-row">
                <div className="font-title font-bold text-black">Billing To</div>
              ...
              <div className="client-form-wrapper sm:w-1/2">
                ...
                <div
                  className={
                    "font-medium " + (isExporting ? "text-xs" : "text-black mb-1")
                  }
                >
                  {!isViewMode ? (
                    <input
                ...
                <div
                  className={
                    "font-medium " + (isExporting ? "text-sm" : "text-black mb-1")
                  }
                >
                  {!isViewMode ? (
                    <input
            ...
            <div className="flex-1">
              <div className="flex flex-row justify-between items-center mb-1">
                <div className="font-title text-black flex-1"> INVOICE # </div>
                <div className="font-title flex-1 text-black">
                  {!isViewMode ? (
                    <input
                    style={{color:'black'}}
                      autoComplete="nope"
              ...
              <div className="flex flex-row justify-between items-center mb-1">
                <div className="font-title text-black flex-1"> Creation Date </div>
                <div className="font-title flex-1 text-black">
                  <DatePicker
                   style={{color:'black',border:"2px solid black"}}
                    ...
                    className={
                      !isViewMode
                        ? defaultInputSmStyle + " border-black text-black"
                        : " text-black bg-white"
                    }
                  />
                </div>
              ...
              <div className="flex flex-row justify-between items-center mb-1">
                <div className="font-title text-black flex-1"> Due Date </div>
                <div className="font-title flex-1 text-black">
                  <DatePicker 
                   style={{color:'black'}}
              ...
              {!isViewMode && (
                <div className="flex flex-row justify-between items-center mb-1">
                  <div className="font-title text-black flex-1"> Change Currency </div>
                  <div className="font-title flex-1 text-black">
                    <input
                      autoComplete="nope"
                      placeholder="Invoice No"
          ...
          <div className="py-2 px-4">
            <div
              ...
              style={{ backgroundColor:"#d19fe8" }}
            >
              <div
                className={
                  "font-title " +
                  (isExporting
                    ? " text-sm w-1/4 text-black pr-10"
                    : " w-full sm:w-1/4 text-black sm:pr-10")
                }
              >
              ...
              <div style={{backgroundColor:"#d19fe8"}}
                className={
                  "font-title" +
                  (isExporting
                    ? " text-sm w-1/4 text-black pr-10"
            ...
            {invoiceForm?.products?.map((product, index) => (
              ...
              >
                <div
                  className={
                    isExporting
                      ? "font-title w-1/4 text-black pr-8 flex flex-row block"
                      : "font-title w-full sm:w-1/4 text-black sm:pr-8 flex flex-row sm:block"
                  }
                >
                  {!isExporting && (
                ...
                <div 
                  className={
                    isExporting
                      ? "font-title w-1/4 text-black pr-9 flex flex-row `1block"
                      : "font-title w-full sm:w-1/4 text-black sm:pr-9 flex flex-row sm:block"
                  }
                >
                  {!isExporting && (
                    <span  className="sm:hidden w-1/2 flex flex-row items-center">
            ...
            {!isViewMode && (
              <div className="flex flex-col sm:flex-row rounded-lg sm:visible w-full px-4 py-2 items-center sm:justify-end">
                <div className="font-title w-full sm:w-1/4 text-black sm:pr-8 flex flex-row sm:block mb-1">
                  <Button size="sm" style={{color:"black"}} block={1} onClick={addEmptyProduct}>
            ...
            >
              <div
                className={
                  isExporting
                    ? "font-title w-1/4 text-black pr-9 flex flex-row block justify-end text-sm "
                    : "font-title w-1/2 sm:w-1/4 text-black sm:pr-8 flex flex-row sm:block mb-1 sm:mb-0"
                }
              >
                Subtotal
              </div>
              <div
                className={
                  isExporting
                    ? "font-title w-1/4 text-black pr-9 flex flex-row block justify-end text-sm "
                    : "font-title w-1/2 sm:w-1/4 text-black sm:pr-9 flex flex-row justify-end sm:block mb-1"
                }
              >
                <NumberFormat
                  value={subTotal}
            ...
            {invoiceForm?.taxes?.map((tax, index) => (
              ...
              >
                <div
                  className={
                    isExporting
                      ? "font-title w-3/5 text-black pr-8 flex flex-row block"
                      : "font-title w-full sm:w-3/5 text-black sm:pr-8 flex flex-row sm:block"
                  }
                >
                  {!isExporting && (
                  ...
                  >
                    ...
                    >
                      {!isViewMode ? (
                        ...
                        <div className="text-black">{tax.title}</div>
                      )}
                    </div>
                  </div>
                </div>
                <div
                  className={
                    isExporting
                      ? "font-title w-1/4 text-black pr-9 flex flex-row text-sm"
                      : "font-title w-full sm:w-1/4 text-black sm:pr-9 flex flex-row sm:block"
                  }
                >
                  {!isExporting && (
            ...
            {!isViewMode && (
              <div className="flex flex-col sm:flex-row rounded-lg sm:visible w-full px-4 py-2 items-center sm:justify-end">
                <div className="font-title w-full sm:w-1/4 text-black sm:pr-8 flex flex-row sm:block mb-1">
                  <Button size="sm" style={{color:"black"}} block={1} onClick={addPercentageTax}>
                    <TaxesIcon style={IconStyle} className="h-5 w-5" />
                    Add Taxes (%)
                  </Button>
                </div>
                <div className="font-title w-full sm:w-1/4 text-black sm:pr-8 flex flex-row sm:block mb-1">
                  <Button size="sm" style={{color:"black"}} block={1} onClick={addEmptyTax}>
                    <DollarIcon style={IconStyle} className="w-5 text-black h-5" />
                    Add Extra Fee
                  </Button>
                </div>
              </div>
            ...
            >
              ...
              >
                <div
                  className={
                    isExporting
                      ? "font-title text-base w-1/2 text-black pr-9 flex flex-row block  justify-end items-center"
                      : "font-title text-lg w-1/2 text-black sm:pr-9 flex flex-row sm:block items-center"
                  }
                >
                  Total
                </div>
                <div
                  className={
                    isExporting
                      ? "font-title text-lg w-1/2 text-black pr-9 flex flex-row block  justify-end items-center"
                      : "font-title text-lg w-1/2 text-black sm:pr-9 flex flex-row justify-end sm:block items-center"
                  }
                >
                  <NumberFormat
            ...
            <div className="flex flex-col flex-wrap sm:flex-row">
              {params.id === "new" && (
                <div className="w-full flex-1 my-1 sm:my-1 md:my-0 px-1">
                  <Button style={{color:'black',backgroundColor:"yellow" ,padding:"10px",border:"3px solid black"}}
                    outlined={1}
                    size="sm"
                    block={1}
                    secondary={1}
              ...
              {invoiceForm?.statusIndex !== "2" && (
                <div className="w-full flex-1 my-1 sm:my-1 md:my-0 px-1">
                  <Button style={{color:'red',backgroundColor:"#FF9999" ,padding:"10px",border:"3px solid black"}}
                    outlined={1}
                    size="sm"
                    block={1}
                    danger={1}
              ...
              <div className="w-full flex-1 my-1 sm:my-1 md:my-0 px-1">
                <Button style={{color:'green',backgroundColor:"#90ee90",padding:"10px",border:"3px solid black"}}
                  size="sm"
                  block={1}
                  success={1}
                  onClick={() => saveAs("Paid")}
